		...
		<div class="button-block">
			...
			<div>
				...
				<ui-itemBox
						...
						Если вы ранее входили на сайте с помощью иностранных сервисов, воспользуйтесь восстановлением пароля, использую ту почту, которая привязана к иностранному сервису через который вы входили"
				/>
			</div>
		</div>
